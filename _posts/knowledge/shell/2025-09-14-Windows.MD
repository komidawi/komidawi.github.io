...
categories: [ shell, cmd ]
tags: [ windows, shell, cmd ] # TAG names should always be lowercase
---
...
To redirect folders into another location use `/D` - directory symbolic link

```shell
mklink /D "C:\Users\komidawi\AppData\Local\Android" "L:\PROGRAMS\LINKED\Android\AppData\Local\Android"
```
