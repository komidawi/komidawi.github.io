...
- Equal objects must have the same `hashCode()` and both methods should use the same **immutable identity fields**, otherwise hash-based collections may not work properly
